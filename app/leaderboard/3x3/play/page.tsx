...
export default function LeaderboardThreeByThreePlayPage({ searchParams }: { searchParams?: { recipient?: string } }) {
  const initialRecipient = typeof searchParams?.recipient === "string" ? searchParams.recipient.slice(0, 80) : "";
