...
- **Working-tree state:** landed on `main` at `b484e34` on 2026-07-28 by a fast-forward of the feature branch (owner-approved direct-to-`main` push; `origin/main` moved `ada2206..b484e34`). Not yet browser/mobile-verified on a real device.
...
- **Deployment:** owner approved a direct push; fast-forwarded `main` to `b484e34` (Vercel production source). The Node-24 CI workflow runs on the push; hosted/mobile verification remains open.
