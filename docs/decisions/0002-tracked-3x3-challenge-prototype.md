...
The owner wants the mobile leaderboard to launch a playable 3x3 challenge that records solve tracking, allows owner/test controls such as manual complete time, and sends the same scramble to another Cube Labs account.
