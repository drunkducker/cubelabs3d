...
function Footer() {
  const groups = [
    ...
    { heading: "Legal", links: [{ label: "Privacy Policy", href: "/privacy" }, { label: "Terms of Service", href: "/terms" }, { label: "Cookie Policy", href: "/cookies" }, { label: "Cookie Settings", href: "/cookies/settings" }, { label: "Data Rights & Deletion", href: "/data-rights" }] },
    { heading: "Safety", links: [{ label: "Community Guidelines", href: "/community-guidelines" }, { label: "Moderation & Appeals", href: "/moderation" }, { label: "Security", href: "/security" }, { label: "Copyright / DMCA", href: "/dmca" }] },
